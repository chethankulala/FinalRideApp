...
class BookingDetailsRepository {
    ...
    init {
        ...
        bookingDetailList.add(BookingDetails("Slot Date", DateTime.dateString))
        bookingDetailList.add(BookingDetails("Time", DateTime.timeString))
        bookingDetailList.add(BookingDetails("Dealer Name","Tune Motors"))
        bookingDetailList.add(BookingDetails("City","Udupi"))
