...
class BookingDetailsActivity : AppCompatActivity(), AuthListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bookingDetailsViewModel = ViewModelProviders.of(this, bookingDetailsViewModelFactory).get(BookingDetailsViewModel::class.java)
        ...
        buttonBookService.setOnClickListener {
    ...
    override fun onSuccess() {
        Log.d("Message:", "dealer successfully created")
