...
class Accessories : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val picture = intArrayOf(R.drawable.bmap1,R.drawable.bmap2,R.drawable.bmap4,R.drawable.bmap3)


        val name = arrayOf("Probiker Gloves","Mike Gloves","Adidas Tubular Gloves","Nike Airmax 1")
        val price = arrayOf("Rs.189.00","Rs 219.00","Rs.189.00","Rs.189.00")
        val date = arrayOf("22 SEP", "28 SEP","29 SEP", "29 SEP")
